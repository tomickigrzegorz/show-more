...
```
---
### For text → [live example](https://github.com/tomik23/show-more#example-text):
```html
...
```
---
### For list → [live example](https://github.com/tomik23/show-more#example-list):
```html
...
### For table → [live example](https://github.com/tomik23/show-more#example-table):
```html
